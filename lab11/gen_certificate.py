"""Code that creates a public and private keypair.

Author: John Schember (john@nachtimwald.com)
URL: https://nachtimwald.com/2019/11/14/python-self-signed-cert-gen/
"""
...
def _gen_openssl():
    import random
    # Note: Will need to install this library in PyCharm
